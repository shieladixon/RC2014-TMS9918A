...
;SPRITE_PATTERN_NAME_DOWNFLAP_TOP_HALF_BLACK:	equ 0
;SPRITE_PATTERN_NAME_DOWNFLAP_BOTTOM_HALF_BLACK:	equ 4
;SPRITE_PATTERN_NAME_DOWNFLAP_TOP_HALF_WHITE:	equ 8
;SPRITE_PATTERN_NAME_DOWNFLAP_BOTTOM_HALF_WHITE:	equ 12	
;SPRITE_PATTERN_NAME_DOWNFLAP_TOP_HALF_YELLOW:	equ 16
;SPRITE_PATTERN_NAME_DOWNFLAP_BOTTOM_HALF_DARK_YELLOW:	equ 20	
;SPRITE_PATTERN_NAME_TOP_HALF_GREY:	equ 24
;SPRITE_PATTERN_NAME_BOTTOM_HALF_RED:	equ 28
;SPRITE_PATTERN_NAME_UPFLAP_TOP_HALF_BLACK:	equ 32
;SPRITE_PATTERN_NAME_UPFLAP_BOTTOM_HALF_BLACK:	equ 36
;SPRITE_PATTERN_NAME_UPFLAP_TOP_HALF_WHITE:	equ 40
;SPRITE_PATTERN_NAME_UPFLAP_BOTTOM_HALF_WHITE:	equ 44	
;SPRITE_PATTERN_NAME_UPFLAP_TOP_HALF_YELLOW:	equ 48
;SPRITE_PATTERN_NAME_UPFLAP_BOTTOM_HALF_DARK_YELLOW:	equ 52	
